---
title: "Does SEO keep working after you stop paying for it?"
seoTitle: "Does SEO Keep Working If You Stop Paying? | Consultico"
excerpt: "In December 2025 we told a client to move their budget off SEO. One of their two sites then improved every month to July. One account, and what it shows."
date: 2026-08-24
updated: 2026-08-24
category: Strategy
type: Case note
...
cta:
  preset: seo
itemList:
  - The work was foundational rather than a publishing habit
  - Demand for the product held up
  - Nobody was out-publishing them in that window
...
faqs:
  ...
  - question: How do you measure SEO ROI after an engagement ends?
    answer: "Compare the same months a year apart on the same set of pages, then count enquiries rather than positions. Search Console will show you clicks and rankings, and it will never tell you what any of it was worth, so the number that settles it has to come from the client's own sales record."
  - question: How do you tell whether your search foundation would survive on its own?
    answer: "Look at where your traffic comes from. If it depends on pages published in the last quarter, it needs the quarter after that. If it comes from pages that have been earning for a year with nothing done to them, you have something that stands up. Search Console's date comparison shows you this in about ten minutes."
---
...
[Norfolk Boards](/case-studies/norfolk-boards) makes garden and indoor games. They came to us in December 2024 on a recommendation from a previous agency, and we built three new websites for them, including Cornhole.co.uk and Shuffleboard.co.uk. The SEO ran through to December 2025, deliberately aimed at the following year instead of the one it was happening in.

In October 2025 they went through [Think First](/think-first), our strategy workshop, which found that the real constraint on the business was the calendar and not the marketing. A British outdoor-games company has a few good months and then a long wait.
...
| Shuffleboard.co.uk | August 2025 | July 2026 |
|---|---|---|
| Average position | 31.6 | 12.2 |
| Clicks per month | 109 | 265 |
...
Both of these brands sell seasonal products. Google's own list of reasons search traffic moves puts "seasonality and changing interests" alongside algorithm updates and technical faults ([Google Search Central](https://developers.google.com/search/docs/monitor-debug/debugging-search-traffic-drops)), so it's the first thing to rule out and the easiest thing to get wrong.
...
You've never been renting the position. Google's own documentation puts it plainly: "Google never accepts money to include or rank sites in our search results, and it costs nothing to appear in our organic search results" ([Google Search Central](https://developers.google.com/search/docs/fundamentals/do-i-need-seo)). What an agency fee buys is the work, and the work leaves things behind. Pages, structure, the internal links between them, whatever other sites have said about you along the way. When the fee stops, none of that gets taken away.
