...
export default function ThinkFirstSection(): JSX.Element {
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-gray-50 shadow-[0_8px_20px_rgba(0,0,0,0.1)]">
      <div className="px-4 sm:px-6 md:px-[5vw] lg:px-[7.5vw]">
        <div className="text-left max-w-4xl mx-auto">
          ...
          <ul className="space-y-4 mb-8 pl-8">
            <li className="text-[clamp(1rem,1.4vw,1.25rem)] leading-[1.6] text-gray-800 font-helvetica-light relative before:content-['•'] before:absolute before:left-[-1.5rem] before:text-brand-blue before:font-bold">
