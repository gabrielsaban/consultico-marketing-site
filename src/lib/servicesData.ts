...
export const services: Service[] = [
  ...
  },
  {
    ...
    highlights: ['PPC agency in Glasgow', 'unit economics', 'how success will be measured'],
    icon: 'target',
    futureSlug: 'ppc',
  ...
  },
  {
    ...
    highlights: ['SEO work helps Glasgow businesses', 'long-term organic visibility', 'generative engine optimisation (GEO)'],
    icon: 'trending-up',
    futureSlug: 'seo',
  ...
  },
  {
    ...
    description: [
      'We build and refresh websites for Glasgow businesses that need to convert - fast, structured around the user journey, with SEO foundations baked in from day one. Your website is open every hour of every day; it either builds trust and converts or loses people in seconds.',
    ...
    highlights: ['websites for Glasgow businesses', 'SEO foundations', 'conversion goal'],
    icon: 'code',
