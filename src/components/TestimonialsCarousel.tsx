      ...
      <div className="grid grid-cols-1 gap-6 md:gap-8">
        {slides.map((t, i) => (
          <motion.div
            ...
            transition={{ duration: 0.45 + i * 0.05, ease: 'easeOut' }}
            className={`flex flex-col h-full rounded-xl bg-white/60 p-6 border border-gray-200 w-full max-w-[900px] ${
          ...
          >
            ...
            <div className="mt-5 flex items-center justify-between gap-3">
              <div>
                <div className="text-gray-700 font-helvetica text-sm md:text-base font-medium">{t.company}</div>
                <div className="text-gray-500 text-xs md:text-sm">{t.author}</div>
              </div>
              {/* 5 stars */}
