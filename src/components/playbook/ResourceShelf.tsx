          ...
          return (
            <li key={r.id}>
              <Link
                ...
                className="flex h-full flex-col gap-2 rounded-[var(--radius)] border border-[var(--r-hair)] bg-[var(--r-surface)] p-4 transition-colors hover:border-[var(--r-brand)]"
              >
              ...
              <ul className="mt-2.5 flex flex-col gap-2">
                {p.items.map((item, i) => (
                  <li key={i} className="flex gap-2.5">
                    ...
                    <span className="font-helvetica text-[length:var(--t-body)] leading-[var(--lh-body)] text-[var(--r-ink-2)]">
                      {item}
                    </span>
                  </li>
                ))}
              ...
              <Card key={p.title}>
                ...
                <ul className="mt-2 flex flex-col gap-2">
                  {p.items.map((item, i) => (
                    <li
                      key={i}
                      className="font-helvetica text-[length:var(--t-small)] leading-[var(--lh-small)] text-[var(--r-ink-2)]"
                    >
                      {item}
                    </li>
                  ))}
