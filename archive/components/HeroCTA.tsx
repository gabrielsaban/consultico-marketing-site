...
export default function HeroCTA({
  ...
  useEffect(() => {
    const measure = () => {
      ...
      const basePadLeft = 48;
      const basePadRight = 48;
      const reserve = Math.max(40, Math.round(labelWidth * 0.2));

      const computedPrBase = basePadRight;
      const computedPrHover = basePadRight + reserve;
  ...
  const button = (
    ...
    >
      ...
      <motion.span
        className="absolute right-6 top-1/2 -translate-y-1/2 text-2xl xl:right-10"
